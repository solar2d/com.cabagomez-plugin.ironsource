...
@property (nonatomic, readonly) Class <CHBAdWebViewControllerConfiguration, CHBIAPPaymentObserverConfiguration, CHBOcurrenceLimitEventThrottlerConfiguration, CHBOmSdkProtocol, CHBSnapshotTakerConfiguration, CHBThrottlingEventTrackerConfiguration, CHBTrackEventRepositoryConfiguration> _Nonnull objcConfiguration;
