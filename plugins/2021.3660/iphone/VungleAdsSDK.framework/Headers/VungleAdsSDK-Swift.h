...
/// For logging errors provided from the template
  VungleErrorMraidError = 63,
/// The IFA changed values between loading and playing the ad object.
  VungleErrorInvalidIfaStatus = 64,
/// The ad response expired. This is fired immediately when the timer detects that it has expired.
  VungleErrorAdExpired = 65,
/// Failed to load the index html
  VungleErrorMraidBridgeError = 66,
/// The ad response expired. This is fired when the pub calls play on an expired ad object.
  VungleErrorAdExpiredOnPlay = 67,
/// Failed to send the win notification url. Message contains the URL
  VungleErrorAdWinNotificationError = 68,
/// Logged if asset fails to be removed on cleanup
  VungleErrorAssetFailedToDelete = 69,
/// Logged if load fails just before ad play
  VungleErrorAdHtmlFailedToLoad = 70,
/// MRAID JS event does not include expected value
  VungleErrorMraidJsCallEmpty = 71,
/// Unable to open deep link URL
  VungleErrorDeeplinkOpenFailed = 72,
/// Failed to evaluate javascript
  VungleErrorEvaluateJavascriptFailed = 73,
/// Failed to open the mraid link command
  VungleErrorLinkCommandOpenFailed = 74,
/// Failed to get the json string from json data
  VungleErrorJsonParamsEncodeError = 75,
/// Failed to generate json data from params dictionary
  VungleErrorGenerateJsonDataError = 76,
/// Template close due to Fatal error reported by template
  VungleErrorAdClosedTemplateError = 77,
/// Missing HeartBeat error
  VungleErrorAdClosedMissingHeartbeat = 78,
/// Pub attempted to call play on a fullscreen ad object with another already playing
  VungleErrorConcurrentPlaybackUnsupported = 79,
/// Pub provided a different size mount for the banner
  VungleErrorBannerViewInvalidSize = 80,
/// missing critical native ad assets
  VungleErrorNativeAssetError = 81,
  VungleErrorWebViewWebContentProcessDidTerminate = 82,
  VungleErrorWebViewFailedNavigation = 83,
  VungleErrorStoreKitLoadError = 84,
  VungleErrorOmsdkCopyError = 85,
  VungleErrorStoreOverlayLoadError = 86,
  VungleErrorReachabilityInitializationFailed = 87,
  VungleErrorUnknownRadioAccessTechnology = 88,
  VungleErrorStoreKitPresentationError = 89,
/// Memory Checks
  VungleErrorOutOfMemory = 90,
};
