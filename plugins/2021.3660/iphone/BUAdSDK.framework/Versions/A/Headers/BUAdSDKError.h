...
extern NSErrorDomain BUAdSDKErrorHost ;
...
typedef NS_ENUM(NSInteger, BUErrorCode) {
    ...
    BUErrorSlotAB_Disable       = 491, // slot ab, feature is disabled
    BUErrorSlotAB_EmptyResult   = 492, // slot ab, slot result is empty

    BUErrorCodeSDKStop          = 1000,     // SDK stop forcely
    
    BUErrorCodeParamError       = 10001,    // parameter error
    BUErrorCodeTimeout          = 10002,
    BUErrorCodeResource         = 10003,
    ...
    BUErrorCodeBiddingAdmExpired    = 40046, // Bidding Adm Expired
