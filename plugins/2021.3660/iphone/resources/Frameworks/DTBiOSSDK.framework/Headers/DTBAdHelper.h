...
+ (BOOL)validateMopubBannerCustomEventWithLocalInfo:(NSDictionary * _Nullable)localParameters serverInfo: (NSDictionary * _Nullable)serverInfo APS_DEPRECATED_MESSAGE();

+ (BOOL)validateMopubInterstitialCustomEventWithLocalInfo:(NSDictionary * _Nullable)localParameters serverInfo: (NSDictionary * _Nullable)serverInfo APS_DEPRECATED_MESSAGE();
...
+ (NSString *)getValueForKeyFromAdMobKeywords:(NSArray * _Nonnull)adMobKeywords key:(NSString * _Nonnull)key APS_DEPRECATED_MESSAGE();
